...
def build_report_prompt(
    *,
    ...
    parts.append(
        ...
        "\"Pre-Step\", \"the framework requires/flags/rules\"), or snake_case divergence ids as "
        "headings — use plain English instead. You may use framework_rule and chart_refs from the "
