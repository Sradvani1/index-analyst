...
CHART_PACK: list[ChartEntry] = [
    ChartEntry(
        ...
        label="SPX 1-day with SMA 20/50/200, Bollinger Bands, RSI-14",
        category="technical",
        timeframe="intraday",
    ),
    ChartEntry(
        ...
        label="SPX 5-day with SMA 20/50/200, Bollinger Bands, RSI-14, MFI",
        category="technical",
        timeframe="5day",
    ),
    ChartEntry(
        ...
        label="SPX 1-month with SMA 20/50/200, Bollinger Bands, RSI-14, MFI",
        category="technical",
        timeframe="1month",
    ),
    ChartEntry(
        ...
        label="SPX 3-month with SMA 20/50/200, Bollinger Bands, RSI-14, MFI",
        category="technical",
        timeframe="3month",
    ),
    ChartEntry(
        ...
        label="SPX 6-month with SMA 20/50/200, Bollinger Bands, RSI-14, MFI",
        category="technical",
        timeframe="6month",
    ),
    ChartEntry(
        ...
        label="SPX 1-year with SMA 20/50/200, Bollinger Bands, RSI-14, MFI",
        category="technical",
        timeframe="1year",
    ),
    ChartEntry(
        ...
        label="SPX 3-year with SMA 20/50/200, Bollinger Bands, RSI-14, MFI",
        category="technical",
        timeframe="3year",
    ),
    ChartEntry(
